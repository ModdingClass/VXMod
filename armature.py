...
def addTK17Bone(translation, orientation,rotation, name, parent) :
	...
	if name in ["spine_end", "neck_end", "lower_jaw_end", "forehead_end", "cheek_R_end", "cheek_L_end", "head_end"] :
		#need to continue
		pass
	elif "_end" in name :
		#return
	...
	breastFixList = ["breast_L_joint", "breast_scale_L_joint", "nipple_L_joint01", "nipple_L_end", "breast_deform01_R_joint01","breast_deform02_R_joint01", "breast_deform03_R_joint01","breast_deform01_R_end","breast_deform02_R_end","breast_deform03_R_end"]
	lipsFixList = ["upper_lip_R_joint01","upper_lip_R_joint02","upper_lip_R_joint03","upper_lip_R_end", "lower_lip_R_joint01","lower_lip_R_joint02","lower_lip_R_joint03","lower_lip_R_end"]
	headFixList = ["cheek_R_joint01", "cheek_R_end","ear_R_joint01", "ear_R_end", "forehead_joint01","forehead_end", "nose_joint01", "nose_joint01","nose_joint02","nose_end"]
	eyeFixList =["eye_socket_R_joint", "eye_brow_R_joint01","eye_brow_R_joint02", "eye_brow_R_end", "eye_R_joint"]
	specialCaseList = ["rib_R_end", "butt_R_end"]
...
def addBonesFromHardcodedValue():
	if (True == True):
		...
		addTK17Bone( (-0.043407869, 0, 0.0045066359 ) , ( -149.63573,  0,  90  )  , ( 0, 0, 0 ) , 'vagina_L_end','vagina_L_joint01')
		addTK17Bone( (-0.074394509, 0.046304256, -0.008 ) , ( 90,  0,  142.51071  )  , ( 360, 0, 360 ) , 'vagina_R_joint01','root')
		addTK17Bone( (0.043407869, 0, -0.0045066359 ) , ( 30.364271,  0,  90  )  , ( 0, 0, 0 ) , 'vagina_R_end','vagina_R_joint01')
		addTK17Bone( (-0.047841728, -0.038221464, 0.07788647 ) , ( -90,  0,  -98.7616  )  , ( 0, 0, 0 ) , 'butt_L_joint01','root')
		addTK17Bone( (0.065647066, 0, 0 ) , ( 91.636574,  0,  -90  )  , ( 0, 0, 0 ) , 'butt_L_end','butt_L_joint01')
		addTK17Bone( (-0.047841728, -0.038221464, -0.078 ) , ( -90,  0,  -98.7616  )  , ( 0, 0, 0 ) , 'butt_R_joint01','root')
		addTK17Bone( (0.065647066, 0, 0 ) , ( 91.636574,  0,  -90  )  , ( 0, 0, 0 ) , 'butt_R_end','butt_R_joint01')
		...
		addTK17Bone( (0.035958286, 0, 0 ) , ( 94.763641,  -90,  0  )  , ( 0, 0, 0 ) , 'testicles_end','testicles_joint02')
		...
		addTK17Bone( (0.039840519, 0, 0 ) , ( 102.99461,  -90,  0  )  , ( 0, 0, 0 ) , 'penis_end','penis_joint03')
		...
		addTK17Bone( (0.036767941, 0, 0 ) , ( -90,  0,  -76.253418  )  , ( 0, 0, 0 ) , 'toe_deform01_L_end','toe_deform01_L_joint01')
		addTK17Bone( (0.039374188, -0.00097012328, -0.032512531 ) , ( 90,  12.166531,  2.7437053  )  , ( 0, 0, 0 ) , 'toe_deform02_L_joint01','ball_L_joint')
		addTK17Bone( (0.028718958, 0, 0 ) , ( -90,  0,  -77.833466  )  , ( 0, 0, 0 ) , 'toe_deform02_L_end','toe_deform02_L_joint01')
		...
		addTK17Bone( (-0.036767948, 0, 0 ) , ( -90,  0,  -76.253418  )  , ( 0, 0, 0 ) , 'toe_deform01_R_end','toe_deform01_R_joint01')
		addTK17Bone( (-0.039374173, 0.00097013445, 0.032513313 ) , ( 90,  12.166535,  2.7437048  )  , ( 0, 0, 0 ) , 'toe_deform02_R_joint01','ball_R_joint')
		addTK17Bone( (-0.028718526, 0, 0 ) , ( -90,  0,  -77.833466  )  , ( 0, 0, 0 ) , 'toe_deform02_R_end','toe_deform02_R_joint01')
		...
		addTK17Bone( (0.07659173, 0, 0 ) , ( 90,  0,  90  )  , ( 0, 0, 0 ) , 'stomach_end','stomach_joint01')
		...
		addTK17Bone( (0.0776199, 0, 0 ) , ( -90,  0,  90  )  , ( 0, 0, 0 ) , 'rib_L_end','rib_L_joint01')
		addTK17Bone( (-0.0014029481, -0.095652826, -0.04569507 ) , ( 180,  89.44426,  180  )  , ( 0, 0, 0 ) , 'rib_R_joint01','spine_joint03')
		addTK17Bone( (0.077619925, 0, 0 ) , ( 90,  0,  90  )  , ( 0, 0, 0 ) , 'rib_R_end','rib_R_joint01')
		...
		addTK17Bone( (-0.0087084556, 0, 0 ) , ( 90,  -0.50702906,  0  )  , ( 0, 0, 0 ) , 'nipple_L_end','nipple_L_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( -11.561043,  23.313871,  -145.12247  )  , ( 0, 0, 0 ) , 'breast_deform01_L_joint01','breast_scale_L_joint')
		addTK17Bone( (0.071436748, 0, -1.7064352e-06 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform01_L_end','breast_deform01_L_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( -0.45403409,  -48.1916,  -178.63318  )  , ( 0, 0, 0 ) , 'breast_deform02_L_joint01','breast_scale_L_joint')
		addTK17Bone( (0.073019817, 0, -1.9734418e-06 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform02_L_end','breast_deform02_L_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( 12.418375,  22.921894,  141.54634  )  , ( 0, 0, 0 ) , 'breast_deform03_L_joint01','breast_scale_L_joint')
		addTK17Bone( (0.069439188, 0, -4.3985779e-06 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform03_L_end','breast_deform03_L_joint01')
		...
		addTK17Bone( (0.0087093385, 0, 0 ) , ( 90,  -0.50702906,  0  )  , ( 0, 0, 0 ) , 'nipple_R_end','nipple_R_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( -11.561043,  23.313871,  -145.12247  )  , ( 0, 0, 0 ) , 'breast_deform01_R_joint01','breast_scale_R_joint')
		addTK17Bone( (-0.071435817, 0, 0 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform01_R_end','breast_deform01_R_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( -0.45403409,  -48.1916,  -178.63318  )  , ( 0, 0, 0 ) , 'breast_deform02_R_joint01','breast_scale_R_joint')
		addTK17Bone( (-0.073021129, 0, 0 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform02_R_end','breast_deform02_R_joint01')
		addTK17Bone( ( 0, 0, 0  ) , ( 12.418375,  22.921894,  141.54634  )  , ( 0, 0, 0 ) , 'breast_deform03_R_joint01','breast_scale_R_joint')
		addTK17Bone( (-0.06943582, 0, 0 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'breast_deform03_R_end','breast_deform03_R_joint01')
		addTK17Bone( (0.1017823145, 0, 0 ) , ( 0,  -0.19204162,  0  )  , ( 0, 0, 0 ) , 'spine_end','spine_joint04')
		addTK17Bone( (0.076593883, 0, 0 ) , ( 0,  9.7023716,  0  )  , ( 0, 0, 0 ) , 'neck_joint01','spine_end')
		...
		addTK17Bone( (-0.029914655, -0.0001108094948, -4.7701619e-06 ) , ( 0,  0,  152.28918  )  , ( 0, 0, 0 ) , 'finger01_L_end','finger01_L_joint03')
		...
		addTK17Bone( (-0.021580048, -0.00015863318, 0 ) , ( 0,  0,  165.822  )  , ( 0, 0, 0 ) , 'finger02_L_end','finger02_L_joint04')
		...
		addTK17Bone( (-0.0239445, -0.00077033497, 0 ) , ( 0,  0,  165.82193  )  , ( 0, 0, 0 ) , 'finger03_L_end','finger03_L_joint04')
		...
		addTK17Bone( (-0.025545767, -0.00036946358, 0 ) , ( 1.2091363e-06,  0,  165.82193  )  , ( 0, 0, 0 ) , 'finger04_L_end','finger04_L_joint04')
		...
		addTK17Bone( (-0.019582551, -0.0017780437, 0 ) , ( 2.6504866e-05,  2.1186415e-06,  165.82193  )  , ( 0, 0, 0 ) , 'finger05_L_end','finger05_L_joint04')
		#
		#
		...
		addTK17Bone( (0.029915491, 0.000112142734, 6.1607811e-06 ) , ( 0,  0,  152.28918  )  , ( 0, 0, 0 ) , 'finger01_R_end','finger01_R_joint03')
		...
		addTK17Bone( (0.021580068, 0.00015606913, 0 ) , ( 0,  0,  165.822  )  , ( 0, 0, 0 ) , 'finger02_R_end','finger02_R_joint04')
		...
		addTK17Bone( (0.023945259, 0.00077390013, 0 ) , ( 0,  0,  165.82193  )  , ( 0, 0, 0 ) , 'finger03_R_end','finger03_R_joint04')
		...
		addTK17Bone( (0.025546048, 0.00036992491, 0 ) , ( -1.6947803e-06,  0,  165.82193  )  , ( 0, 0, 0 ) , 'finger04_R_end','finger04_R_joint04')
		...
		addTK17Bone( (0.019581646, 0.0017750047, 1.3131448e-06 ) , ( 2.5846904e-05,  1.8967539e-06,  165.82193  )  , ( 0, 0, 0 ) , 'finger05_R_end','finger05_R_joint04')
		addTK17Bone( (0.057289507, 0, 0 ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'neck_end','neck_joint01')
		addTK17Bone( (0.063364767, 0, 0.0065263966 ) , ( 0,  -9.241,  0  )  , ( 0, 0, 0 ) , 'head_joint01','neck_end')
		addTK17Bone( ( 0, 0, 0  ) , ( 0, 0, 0 ) , ( 0, 0, 0 ) , 'head_joint02','head_joint01')
		addTK17Bone( (0.1851493, 0, 0 ) , ( 179.75183,  0,  90  )  , ( 0, 0, 0 ) , 'head_end','head_joint02')
		addTK17Bone( (0.047308434, 0, -0.1194366738 ) , ( 0,  -10.177103,  180  )  , ( 0, 0, -360 ) , 'forehead_joint01','head_joint02')
		addTK17Bone( (-0.024121732, 0, 0 ) , ( 169.57419,  0,  -90  )  , ( 0, 0, 0 ) , 'forehead_end','forehead_joint01')
		addTK17Bone( (0.021159774, 0.0499147, -0.064211346 ) , ( -25.139944,  62.435097,  157.46184  )  , ( 0, 0, 0 ) , 'cheek_L_joint01','head_joint02')
		addTK17Bone( (0.037414048, 0, 5.5876008e-06 ) , ( 64.889458,  4.8634748,  -79.745918  )  , ( 0, 0, 0 ) , 'cheek_L_end','cheek_L_joint01')
		addTK17Bone( (0.021158574, -0.049914677, -0.064211331 ) , ( 154.86006,  -62.435097,  22.538168  )  , ( 0, 0, 0 ) , 'cheek_R_joint01','head_joint02')
		addTK17Bone( (-0.03741147, 0, 0 ) , ( 64.889458,  4.8634748,  -79.745918  )  , ( 0, 0, 0 ) , 'cheek_R_end','cheek_R_joint01')
		addTK17Bone( (0.031983055, 0.0758534, -0.014261107 ) , ( 0,  7.2121744,  180  )  , ( 0, 0, 0 ) , 'ear_L_joint01','head_joint02')
		addTK17Bone( (0.026958896, 0, 0 ) , ( 6.9634686,  0,  -90  )  , ( 0, 0, 0 ) , 'ear_L_end','ear_L_joint01')
		addTK17Bone( (0.031984262, -0.075853437, -0.014261103 ) , ( -180,  -7.2121744,  0  )  , ( 0, 0, 0 ) , 'ear_R_joint01','head_joint02')
		addTK17Bone( (-0.026961459, 0, 0 ) , ( 6.9634686,  0,  -90  )  , ( 0, 0, 0 ) , 'ear_R_end','ear_R_joint01')
		...
		addTK17Bone( (-0.0202144, 0, 0 ) , ( 88.876694,  0,  -90  )  , ( 0, 0, 0 ) , 'nose_end','nose_joint02')
		...
		addTK17Bone( (0.017326185, 0, 0 ) , ( 91.027107,  2.9025409,  -160.50323  )  , ( 0, 0, 0 ) , 'upper_lip_L_end','upper_lip_L_joint03')
		...
		addTK17Bone( (-0.017283283, 0, 0 ) , ( 91.035393,  2.9261374,  -160.50423  )  , ( 0, 0, 0 ) , 'upper_lip_R_end','upper_lip_R_joint03')
		...
		addTK17Bone( (0.013605733, 0, 0 ) , ( 102.89612,  17.151382,  33.765743  )  , ( 0, 0, 0 ) , 'eye_brow_L_end','eye_brow_L_joint02')
		...
		addTK17Bone( (-0.013605733, 0, 0 ) , ( 102.89612,  17.151382,  33.765743  )  , ( 0, 0, 0 ) , 'eye_brow_R_end','eye_brow_R_joint02')
		...
		addTK17Bone( (0.030158687, 0, 0 ) , ( -180,  0,  -22.48103  )  , ( 0, 0, 0 ) , 'lower_jaw_end','lower_jaw_joint01')
		addTK17Bone( (0.037222072, 0, 0 ) , ( 0,  0,  19.701273  )  , ( 0, 0, 0 ) , 'chin_joint01','lower_jaw_end')
		addTK17Bone( (0.04334604, 0, 0 ) , ( -13.894247,  90,  0  )  , ( 0, 0, 0 ) , 'chin_end','chin_joint01')
		...
		addTK17Bone( (-0.016967295, 0, 0 ) , ( 88.164955,  -5.4077697,  -161.22426  )  , ( 0, 0, 0 ) , 'lower_lip_R_end','lower_lip_R_joint03')
		...
		addTK17Bone( (0.016967608, 0, 1.9150691e-06 ) , ( 88.164955,  -5.4077697,  -161.22426  )  , ( 0, 0, 0 ) , 'lower_lip_L_end','lower_lip_L_joint03')
		#
		...
		#addTK17Bone( (0.013714936, 0, 0 ) , ( 155.4445, -90, 0 ) , ( 0, 0, 0  ) , 'tongue_end','tongue_joint05')
		#
		#
		#IGNORE IT for now
...
def post_import_armature():
	...
	for ob in bpy.data.objects:
		...
		if ob.type == 'EMPTY' and ob.name.startswith(prefix) and "corrector" not in ob.name:
			...
			if upper_lip_R_joint01_child or lower_lip_R_joint01_child or upper_lip_L_joint01_child or lower_lip_L_joint01_child:
				length = 0.015
			if ob.name[len(prefix):] in ["neck_joint01", "neck_end", "spine_end", "head_joint01"]:
				length = 0.05
			...
			if ob.name[len(prefix):] in ["butt_L_joint01","butt_R_joint01","rib_R_joint01","rib_L_joint01", "stomach_joint01" ]:
				length = 0.06			
			if ob.name[len(prefix):] in ["nipple_R_joint01","nipple_R_end","nipple_L_joint01","nipple_L_end", "breast_deform03_R_end","breast_deform03_L_end","breast_deform02_R_end","breast_deform02_L_end","breast_deform01_L_end","breast_deform01_R_end" ]:
				length = 0.01						
			...
			if "_end" in ob.name:
				if ob.name[len(prefix):] in ["spine_end", "neck_end", "lower_jaw_end", "forehead_end", "head_end"] :
					pass
				else:
	...
	#bpy.data.objects["clavicle_L_joint"].hide = False
	#bpy.data.objects["neck_end"].hide = False
