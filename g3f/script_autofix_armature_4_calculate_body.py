...
toe_deform01_end_R_head =  getCenter (toe_deform01_top_R, obj)

toe_deform01_joint01_R_tail =  toe_deform01_end_R_head.copy()
toe_deform01_end_R_tail =  toe_deform01_end_R_head.copy()
toe_deform01_end_R_tail.x -= 0.02

toe_deform02_joint01_R_head =  getCenter (toe_deform02_base_R, obj)
toe_deform02_end_R_head =  getCenter (toe_deform02_top_R, obj)

toe_deform02_joint01_R_tail =  toe_deform02_end_R_head.copy()
toe_deform02_end_R_tail =  toe_deform02_end_R_head.copy()
toe_deform02_end_R_tail.x -= 0.02
...
toe_deform01_end_L_head =  getCenter (toe_deform01_top_L, obj)

toe_deform01_joint01_L_tail =  toe_deform01_end_L_head.copy()
toe_deform01_end_L_tail =  toe_deform01_end_L_head.copy()
toe_deform01_end_L_tail.x += 0.02

toe_deform02_joint01_L_head =  getCenter (toe_deform02_base_L, obj)
toe_deform02_end_L_head =  getCenter (toe_deform02_top_L, obj)

toe_deform02_joint01_L_tail =  toe_deform02_end_L_head.copy()
toe_deform02_end_L_tail =  toe_deform02_end_L_head.copy()
toe_deform02_end_L_tail.x += 0.02
...
finger01_end_R_head = getCenter (finger01_end_R, obj)
...
finger02_end_R_head = getCenter (finger02_end_R, obj)
...
finger03_end_R_head = getCenter (finger03_end_R, obj)
...
finger04_end_R_head = getCenter (finger04_end_R, obj)
...
finger05_end_R_head = getCenter (finger05_end_R, obj)
...
finger01_end_L_head = getCenter (finger01_end_L, obj)
...
finger02_end_L_head = getCenter (finger02_end_L, obj)
...
finger03_end_L_head = getCenter (finger03_end_L, obj)
...
finger04_end_L_head = getCenter (finger04_end_L, obj)
...
finger05_end_L_head = getCenter (finger05_end_L, obj)
